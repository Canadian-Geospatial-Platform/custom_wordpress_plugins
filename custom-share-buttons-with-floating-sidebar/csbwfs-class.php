...
$style=' style="top:'.$margin.';right:-5px;"';	$idName=' id="csbwfs-right"';  $hideImg='show.png';
         $showImg =  $lang_en ? 'hide-r.png' : 'hide-r-fr.png';
...
if($pluginOptionsVal['csbwfs_show_btn']!=''){ $showbtn=$pluginOptionsVal['csbwfs_show_btn'];} 
   else{$showbtn= $lang_en ? 'Show Buttons' : 'afficher les boutons';}
//get show/hide button message 
if($pluginOptionsVal['csbwfs_hide_btn']!=''){ $hidebtn=$pluginOptionsVal['csbwfs_hide_btn'];} 
   else{$hidebtn= $lang_en ? 'Hide Buttons' : 'masquer les boutons';}
...
$floatingSidebarContent .= '<div class="csbwfs-show"><a href="javascript:" aria-label="' . $showbtn . '"  title="'.$showbtn.'" id="csbwfs-show"><img src="'.plugins_url('custom-share-buttons-with-floating-sidebar/images/'.$showImg).'" alt="'.$showbtn.'"></a></div>';
endif;
...
$floatingSidebarContent .='<div class="csbwfs-sbutton csbwfsbtns"><div id="csbwfs-fb" class="csbwfs-fb"><a href="javascript:" aria-label="'. $fImgAlt .'" onclick="javascript:window.open(\'//www.facebook.com/sharer/sharer.php?u='.$shareurl.'\', \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600\');return false;" target="_blank" title="'.$fImgAlt.'" '.$fImgbg.'>';

if($fImg!=''){
$floatingSidebarContent .='<img src="'.$fImg.'" alt="'.$fImgAlt.'" width="35" height="35" >';
}else{
$floatingSidebarContent .='<i class="csbwfs_facebook" aria-hidden="true"></i>';
}
...
$floatingSidebarContent .='<div class="csbwfs-sbutton csbwfsbtns"><div id="csbwfs-tw" class="csbwfs-tw"><a href="javascript:" aria-label="'. $tImgAlt .'" onclick="window.open(\'//twitter.com/share?url='.$shareurl.'&text='.$ShareTitle.'\',\'_blank\',\'width=800,height=300\')" title="'.$tImgAlt.'" '.$tImgbg.'>';
	if($tImg!='')
	{
	  $floatingSidebarContent .='<img src="'.$tImg.'" alt="'.$tImgAlt.'" width="35" height="35" >';
	}else{
	  $floatingSidebarContent .='<i class="csbwfs_twitter" aria-hidden="true"></i>';
	}
$floatingSidebarContent .='</a></div></div>';
...
$floatingSidebarContent .='<div class="csbwfs-sbutton csbwfsbtns"><div id="csbwfs-li" class="csbwfs-li"><a href="javascript:" aria-label="'. $lImgAlt .'" onclick="javascript:window.open(\'//www.linkedin.com/cws/share?mini=true&url='. $shareurl.'\',\'\',\'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=800\');return false;" title="'.$lImgAlt.'" '.$lImgbg.'>';
	if($lImg!='')
	{
	  $floatingSidebarContent .='<img src="'.$lImg.'" alt="'.$lImgAlt.'" width="35" height="35" >';
	}else{
	  $floatingSidebarContent .='<i class="csbwfs_linkedin" aria-hidden="true"></i>';
	}
$floatingSidebarContent .='</a></div></div>';
endif;
...
$floatingSidebarContent .='<div class="csbwfs-sbutton csbwfsbtns"><div id="csbwfs-ml" class="csbwfs-ml"><a href="mailto:'.$mailMsg.'" aria-label="'. $mImgAlt .'" title="'.$mImgAlt.'" '.$mImgbg.' >';
	if($mImg!='')
	{
	  $floatingSidebarContent .='<img src="'.$mImg.'" alt="'.$mImgAlt.'" width="35" height="35" >';
	}else{
	  $floatingSidebarContent .='<i class="csbwfs_mail" aria-hidden="true"></i>';
	}
$floatingSidebarContent .='</a></div></div>';
endif;
...
if($isActiveHideShowBtn!='yes') :
$floatingSidebarContent .='<div class="csbwfs-hide"><a href="javascript:" aria-label="' . $hidebtn . '" title="'.$hidebtn.'" id="csbwfs-hide"><img src="'.plugins_url('custom-share-buttons-with-floating-sidebar/images/'.$hideImg).'" alt="'.$hidebtn.'"></a></div>';
endif;
